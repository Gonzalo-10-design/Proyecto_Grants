      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="text-lg sm:text-xl text-gray-700">
          ...
          <div className="flex justify-center gap-6">
            <a href="https://www.linkedin.com/company/isateck" target="_blank" rel="noopener noreferrer" className="text-[#1ea34a] hover:underline">LinkedIn</a>
            <a href="https://www.twitter.com/isateck" target="_blank" rel="noopener noreferrer" className="text-[#1ea34a] hover:underline">Twitter</a>
            <a href="https://www.facebook.com/isateck" target="_blank" rel="noopener noreferrer" className="text-[#1ea34a] hover:underline">Facebook</a>
          </div>
        </div>
      </div>
    </div>
